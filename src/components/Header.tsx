...
const Header: React.FC = () => {
  ...
  return (
    <div className="flex justify-end pr-4 pt-3 space-x-4 items-center">
        ...
        <TbGridDots className='text-4xl hover:bg-gray-200 p-2 rounded-full cursor-pointer' />
        <Image width={30} height={100}   src={url} alt="dp" className="rounded-full cursor-pointer object-cover" style={{height:30}}/>
